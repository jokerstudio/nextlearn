          ...
          <div className="grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-6 lg:grid-cols-3 xl:gap-x-8">
            <a className="group" href="/products/">
              ...
              <div className="mt-4 flex items-center justify-between text-base font-medium text-gray-900">
                <h3>Annuals</h3>
                <div className="inline"><Image className="pt-3" src={ETHLogo} height={28} width={28} /><div className="-ml-1 text-xl inline">1</div></div>
              </div>
            ...
            <a className="group" href="/products/paykit">
              ...
              <div className="mt-4 flex items-center justify-between text-base font-medium text-gray-900">
                <h3>Paykit</h3>
                <div className="inline"><Image className="pt-3" src={ETHLogo} height={28} width={28} /><div className="-ml-1 text-xl inline">0.05</div></div>
              </div>
            ...
            <a className="group" href="/products/tiers">
              ...
              <div className="mt-4 flex items-center justify-between text-base font-medium text-gray-900">
                <h3>Tiers</h3>
                <div className="inline"><Image className="pt-3" src={ETHLogo} height={28} width={28} /><div className="-ml-1 text-xl inline">0.1</div></div>
              </div>
              <p className="mt-1 text-sm italic text-gray-500">UI Kit</p>
            </a>
            <a className="group" href="/products/format">
              ...
              <div className="mt-4 flex items-center justify-between text-base font-medium text-gray-900">
                <h3>Format</h3>
                <div className="inline"><Image className="pt-3" src={ETHLogo} height={28} width={28} /><div className="-ml-1 text-xl inline">1.5</div></div>
              </div>
              <p className="mt-1 text-sm italic text-gray-500">UI Kit</p>
            </a>
            <a className="group" href="/products/unicons">
              ...
              <div className="mt-4 flex items-center justify-between text-base font-medium text-gray-900">
                <h3>Unicons</h3>
                <div className="inline"><Image className="pt-3" src={ETHLogo} height={28} width={28} /><div className="-ml-1 text-xl inline">0.004</div></div>
              </div>
            ...
            <a className="group" href="/products/inbound">
              ...
              <div className="mt-4 flex items-center justify-between text-base font-medium text-gray-900">
                <h3>Inbound</h3>
                <div className="inline"><Image className="pt-3" src={ETHLogo} height={28} width={28} /><div className="-ml-1 text-xl inline">0.2</div></div> 
              </div>
              <p className="mt-1 text-sm italic text-gray-500">Template</p>
            </a>
          </div>
