...
export default function Products({ pageProps }: AppProps) {
    return (
        <>
            <main className="max-w-7xl mx-auto pt-14 px-4 sm:pt-24 sm:px-6 lg:px-8">
                <div className="lg:grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-16">
                    ...
                    <div className="max-w-2xl mx-auto mt-14 sm:mt-16 lg:max-w-none lg:mt-0 lg:col-span-3">
                        <div className="flex flex-col-reverse">
                            <div>
                                <h1 className="text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl">Tattoo mind</h1>
                                <h2 id="information-heading" className="sr-only">Product information</h2>
                                <div>
                                    <div className="flex relative w-12 h-12 bg-orange-500 justify-center items-center m-1 mr-2 text-xl rounded-full text-white">0 </div>
                                    <p className="text-sm text-gray-500 mt-2 inline">0x45544..x · mint by <time>07 Sep 2021</time></p>
                                </div>
                            </div>
                        </div>
                        <p className="text-gray-500 mt-6">This is my tattoo create from my mind</p>
                ...
                <div className="max-w-2xl mx-auto mt-24 lg:mt-32 lg:max-w-none">
                    <div className="flex items-center justify-between space-x-4">
                        ...
                        <Link href="/"><a className="whitespace-nowrap text-sm font-medium text-gray-900 hover:text-gray-700" >View all<span aria-hidden="true"> →</span></a></Link>
                    </div>
